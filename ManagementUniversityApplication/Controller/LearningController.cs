...
namespace ManagementUniversityApplication.Controller
{
    internal class LearningController:Model.Connection
    {
        ...
        public void addLearning(string LrnId, string LrnStId, string LrnStName, string LrnCId, string LrCName, string LrCRoom, DateTime LrnTimes, string LrnLrId,string LrnLrName, int LrnDuration)
        {
            ...
            try
            {
                ...
                cmd.Parameters.Add("@LrnId", MySqlConnector.MySqlDbType.VarChar).Value = LrnId;
                cmd.Parameters.Add("@LrnStId", MySqlConnector.MySqlDbType.VarChar).Value = LrnStId;
                cmd.Parameters.Add("@LrnStName", MySqlConnector.MySqlDbType.VarChar).Value = LrnStName;
                cmd.Parameters.Add("@LrnCId", MySqlConnector.MySqlDbType.VarChar).Value = LrnCId;
                ...
                cmd.Parameters.Add("@LrnLrId", MySqlConnector.MySqlDbType.VarChar).Value = LrnLrId;
        ...
        public void updateLearning(string LrnId, string LrnStId, string LrnStName, string LrnCId, string LrCName, string LrCRoom, DateTime LrnTimes, string LrnLrId, string LrnLrName, int LrnDuration)
        {
        ...
        public void deleteLearning(string LrnId)
        {
